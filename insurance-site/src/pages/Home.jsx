      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 to-blue-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid gap-8 md:grid-cols-2 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/3] bg-white/10 rounded-xl ring-1 ring-white/20 backdrop-blur-sm flex items-center justify-center">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={item.title} className="rounded-xl border p-6 hover:shadow-sm transition">
